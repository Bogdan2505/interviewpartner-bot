...
public final class MainMenuBuilder {
    ...
    private static final String WELCOME_RU = """
            ...
            Здесь вы договариваетесь о взаимной практике: один час — две половины по ~30 минут, роли в парах чередуются.
            В календаре: 🫱 — заявка на собеседование, 🤝 — согласованное, ✅ — есть слоты или активность в этот день.
