...
public class HelpCommandHandler implements BotCommandHandler {
    ...
    public static final String HELP_TEXT = """
            ...
            Встреча длится 60 минут: две половины по ~30 минут с чередованием ролей (интервьюер и кандидат), одна ссылка Jitsi на весь час.
            В календаре выбора времени: 🫱 — ваша заявка, 🤝 — согласованное собеседование, ✅ — открытый слот другого участника.
            ...
            • Расписание — календарь ваших заявок и согласованных собеседований: по дням ✅ отмечены дни с событиями, по часам — 🫱 и 🤝.
