...
public class HelpCommandHandler implements BotCommandHandler {
    ...
    public static final String HELP_TEXT = """
            ...
            • Записаться на собеседование — выбрать язык и время: присоединиться к уже открытому часовому слоту другого участника или создать свой открытый слот. 
            Встреча длится 60 минут: первые ~30 минут один из вас в роли интервьюера, вторые ~30 минут — наоборот (одна ссылка Jitsi на весь час).
